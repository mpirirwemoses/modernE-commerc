...
CREATE TABLE `cart_items` (
    ...
    UNIQUE INDEX `cart_items_userId_productId_variantId_key`(`userId`, `productId`, `variantId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `payments` (
    ...
    `currency` VARCHAR(191) NOT NULL DEFAULT 'USD',
    `method` ENUM('CREDIT_CARD', 'PAYPAL', 'MTN_MONEY', 'AIRTEL_MONEY', 'BANK_TRANSFER', 'CASH_ON_DELIVERY') NOT NULL,
    `status` ENUM('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'CANCELLED', 'REFUNDED') NOT NULL DEFAULT 'PENDING',
    `transactionId` VARCHAR(191) NULL,
    `gateway` ENUM('STRIPE', 'PAYPAL', 'MTN_MOBILE_MONEY', 'AIRTEL_MONEY', 'BANK', 'CASH') NOT NULL,
